...
overlap_percentage_linspace = np.linspace(0.1,0.9,16)
window_size=450
...
for i in range(len(overlap_percentage_linspace)):

    overlap_percentage=overlap_percentage_linspace[i]
...
ax[0].plot(overlap_percentage_linspace, trainAcc_list, 'b-', label='Training Accuracy')
ax[0].plot(overlap_percentage_linspace, testAcc_list, 'r-', label='Testing Accuracy')
...
ax[1].plot(overlap_percentage_linspace, totalTime_list, 'g-')
...
print(f'window size : {overlap_percentage_linspace[max_i]}')
